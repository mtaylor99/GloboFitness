...
class _SessionsScreenState extends State<SessionsScreen> {
  ...
  final TextEditingController txtDescrption = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Your training Session')),
  ...
  Future saveSession() async {
    ...
    Session newSession = Session(
        id, today, txtDescrption.text, int.tryParse(txtDuration.text) ?? 0);
